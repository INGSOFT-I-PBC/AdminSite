...
<template>
    <div class="tw-flex tw-flex-col">
        ...
        <div class="t-input-text" :class="[colorscheme[theme]]" :classa="[inputDivClass, colorscheme[theme]]">
            <button class="tw-text-center tw-ml-1 tw-grid tw-content-center focus:tw-outline-none"
            ...
            <button class="tw-text-center tw-p-0.5 tw-content-center tw-grid focus:tw-outline-none" v-if="rightIcon"

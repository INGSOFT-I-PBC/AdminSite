...
<template>
    <div class="tw-flex tw-flex-rows tw-justify-items-stretch tw-min-h-screen tw-w-full tw-justify-between tw-bg-neutral-100 dark:tw-bg-neutral-900 tw-overflow-x-hidden"
        id="_root">
        <aside class="tw-h-full tw-min-w-fit tw-bg-slate-600 tw-rounded-r-xl tw-overflow-hidden">
        ...
        <div class="resize-handle--x tw-cursor-ew-resize tw-justify-center hover:tw-bg-primary-light tw-w-1 hover:tw-animate-pulse hover:tw-transition tw-ease-in-out tw-duration-700 tw-bg-transparent"
            data-target="aside" />
        <!-- Right view -->
        <main class="tw-px-4 tw-py-2 tw-justify-items-stretch tw-w-full tw-gap-3 tw-flex-1 tw-flex tw-flex-col"
            id="right-panel">
            <header class="tw-flex tw-flex-row tw-gap-3 tw-justify-between tw-justify-items-stretch">
                ...
                <div id="_page-title-container"
                    ...
                    <h1 class="tw-font-bold tw-text-on-secondary dark:tw-text-on-secondary-hard tw-text-2xl">
                        {{ title }}
                    </h1>
                </div>
            </header>
                ...
                <div id="_breadcrumb-container"
                    ...
                    <TransitionGroup enter-active-class="tw-transition-all tw-duration-400"
                        ...
                        <div v-for="(item, index) of breadcrumb" :key="index">
                            ...
                            <RouterLink v-else class="hover:tw-text-primary hover:tw-font-bold" :to="item.href || '/'">

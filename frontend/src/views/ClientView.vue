...
<template>
    <main>
        <ModalDialog id="client-modal" v-model:show="productModalShow" title="Detalle del cliente">
        ...
        <ECard>
            ...
            <Table :header="tableSettings">
                <template #body-cell="{ cellData, colIdx, rowIdx }">
                    ...
                    <div v-else-if="colIdx > 6" class="tw-grid tw-grid-flow-col tw-rounded tw-overflow-hidden">
                        <button class="tw-bg-blue-600 tw-px-4 tw-py-1 tw-text-white tw-mx-2 tw-rounded"

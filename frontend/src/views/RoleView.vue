        ...
        <aside class="tw-h-full tw-min-w-fit tw-bg-slate-600 tw-rounded-r-xl tw-overflow-hidden">
            <div id="__left-drawer"
                ...
                <div id="__left-logo-container"
                    ...
                    <EButton @click="btn_agregar()" variant="secondary">+ Agregar rol
                    </EButton>
                </div>
                <div id="__left-menu-container" class="tw-w-full tw-flex-1 tw-overflow-y-auto tw-bg-gray-200">
                    <DrawerMenu>
            ...
            <div class="row tw-grid tw-z-10">
                ...
                <div v-else-if="tiposeleccion == 1">
                    <EForm @submit="onSubmit">
                        ...
                        <input type="text" class="form-control" placeholder="23/08/2022" disabled="false"

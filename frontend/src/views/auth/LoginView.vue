    ...
    <div
        ...
        <ECard class="tw-bg-gray-900">
            ...
            <form @onsubmit="inactive">
                <InputText label="Usuario" :info-label="toggleUsername ? 'campo requerido' : ''" placeholder="usuario"
                    v-model="username" info-status="danger"></InputText>
                <!--<span class="text-xs tracking-wide text-red-600">Email field is required </span>-->
                <div class="mt-4">
                    <InputText label="Contraseña" :info-label="togglePassword ? 'campo requerido' : ''"
                        placeholder="contraseña" v-model="password" :type="toggle ? 'text' : 'password'" id="password"
                        :right-icon="toggle ? 'eye-off' : 'eye'" @right-icon-click="switchVisibility"
                        info-status="danger">
                    </InputText>
                    <!--rightIcon="eye"-->
                </div>
                <div class="tw-text-center">
                    ...
                    <div class="flex items-baseline justify-between mt-4">
                        <a class="text-sm text-blue-600 hover:underline">¿Olvidó su contraseña?</a>
                    </div>
                </div>
            </form>
        </ECard>
